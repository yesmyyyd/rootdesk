...
> **注：项目目前处于内测阶段，暂未开放源代码，仅提供编译后的部署包。**

### 1. 部署控制端 (Server)
控制端提供基于 Node.js 的运行包，你可以将其部署在任何拥有公网 IP 或内网可达的服务器上。
...
**部署步骤：**
1. 下载并解压控制端部署包。 
RootDesk部署包下载 https://pan.baidu.com/s/1jI8bwrQ4b78b_h_yxvArxA?pwd=ept9

2. 在根目录下执行依赖安装（如包内未包含）：
   ```bash
...
如果你在部署过程中遇到任何问题，或者有功能建议，欢迎通过以下方式联系我们。**欢迎加入我们的讨论群进行交流与反馈！**

- **作者微信**: yesmyyyd (添加请备注: RootDesk)
- **讨论群**: 添加上方微信后拉你进群
- **Issue**: [提交反馈](#)
